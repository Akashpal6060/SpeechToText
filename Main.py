...
for audio_file in audio_files:
    ...
    with open(f"D:/git_tutorial/SpeechToText/Output_files/{file_name}_transcription.txt", "w") as text_file:
        text_file.write(full_text)

    # Save the transcribed text as a PDF file
    pdf_output_path = f"D:/git_tutorial/SpeechToText/Output_files/{file_name}_transcription.pdf"
